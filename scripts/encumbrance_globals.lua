...
tClumsyArmorTypes = {
    'Fortress plate', 'Half-plate', 'Lamellar (iron)', 'Lamellar (stone coat)',
    'Splint mail'
}
...
function onInit()
    ...
    for i, _ in ipairs(tClumsyArmorTypes) do
        ...
        for _, vv in ipairs(tSpecialCharacters) do
            tClumsyArmorTypes[i] = string.gsub(tClumsyArmorTypes[i], vv,
                                               '%' .. vv)
        end
    end
end
...
tEncumbranceSpeed = {
    '5', '10', '10', '15', '20', '20', '25', '30', '30', '35', '40', '40', '45',
    '50', '50', '55', '60', '60', '65', '70', '70', '75', '80', '80'
}
